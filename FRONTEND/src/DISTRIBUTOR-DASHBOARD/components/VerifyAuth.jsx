    ...
    <>
      <div className="body">
        <div className="container">
          <form
            className="form-verify bg-white mx-auto rounded-5"
            onSubmit={onSubmit}
          >
            ...
            <div className="form-fields">
              ...
              <div className="mb-5">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="bg-primary-normal text-white border-0 font-archivo fw-semibold fs-6 rounded-1 d-inline-block w-100 py-3"
                >
                  {isLoading ? (
                    <>
                      <span
              ...
              <div className="mb-4 mt-5">
                <button
                  ...
                  className="bg-transparent google-signin-btn border-1 font-archivo fw-semibold fs-6 text-dark-blue rounded-1 d-inline-block w-100 py-3"
                >
                  {secondBtnText}
                </button>
              </div>
